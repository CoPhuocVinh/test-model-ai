...
export function createPendingAction(action: DeviceAction, candidates: DeviceSummary[]) {
...
export function consumePendingAction(pendingActionId: string, deviceId: string) {
